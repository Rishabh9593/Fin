<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg_page.aspx.cs" Inherits="voting.reg_page" %>
...
<body style="text-align:center; background-color:lightgoldenrodyellow;">
    ...
    <div>
        ...
        <div>
            ...
            <asp:Button ID="login" runat="server" Text="Login page" OnClick="login_page_Click" style="background-color:#4CAF50; width: 10%; padding: 9px 5px; margin:5px 0; cursor:pointer; border:none; color:#ffffff; margin-left: 80px;" />
        </div>
    </form>
